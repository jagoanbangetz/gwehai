...
describe('UploadsController', () => {
  ...
  describe('path traversal prevention', () => {
    ...
    it('should neutralize absolute path to relative inside uploads', () => {
      // /etc/passwd → leading slash stripped → etc/passwd → resolves inside uploads
      controller.serveFile('images', '/etc/passwd', mockRes);
      const expectedPath = path.resolve(uploadsRoot, 'images', 'etc', 'passwd');
