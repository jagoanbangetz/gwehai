...
const Dashboard = () => {
  ...
  return (
    <div className="dashboard">
      ...
      {showCurrentPentestModal && <CurrentPentestModal jobs={currentPentestJobs} isLoading={currentPentestLoading} error={currentPentestError} onClose={() => setShowCurrentPentestModal(false)} />}
    </div>
  )
}
